var btn=document.getElementById('toggle-theme');var currentTheme=localStorage.getItem("w-theme");if(currentTheme=="light"){document.body.classList.add("light-theme");}else{document.body.classList.add("dark-theme");}
changeIconTheme(currentTheme);btn.addEventListener("click",function(){document.body.classList.toggle("dark-theme");let theme="dark";if(document.body.classList.contains("light-theme")){theme="dark";document.body.className="";document.body.classList.add("dark-theme");}else{theme="light";document.body.className="";document.body.classList.add("light-theme");}
changeIconTheme(theme);localStorage.setItem("w-theme",theme);});function changeIconTheme(theme){var icon=document.getElementById('icon-theme');const utterances=document.querySelector('.utterances-frame');if(theme=="light"){const message={type:'set-theme',theme:'github-light'};if(utterances!=null){utterances.contentWindow.postMessage(message,'https://utteranc.es');}
icon.removeAttribute("d");icon.setAttribute("d","M12.34,2.02C6.59,1.82,2,6.42,2,12c0,5.52,4.48,10,10,10c3.71,0,6.93-2.02,8.66-5.02C13.15,16.73,8.57,8.55,12.34,2.02z");}else{const message={type:'set-theme',theme:'photon-dark'};if(utterances!=null){utterances.contentWindow.postMessage(message,'https://utteranc.es');}
icon.removeAttribute("d");icon.setAttribute("d","M6.76 4.84l-1.8-1.79-1.41 1.41 1.79 1.79 1.42-1.41zM4 10.5H1v2h3v-2zm9-9.95h-2V3.5h2V.55zm7.45 3.91l-1.41-1.41-1.79 1.79 1.41 1.41 1.79-1.79zm-3.21 13.7l1.79 1.8 1.41-1.41-1.8-1.79-1.4 1.4zM20 10.5v2h3v-2h-3zm-8-5c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm-1 16.95h2V19.5h-2v2.95zm-7.45-3.91l1.41 1.41 1.79-1.8-1.41-1.41-1.79 1.8z");}}
var content=document.getElementById('article');window.addEventListener('scroll',()=>{if(content!=null){var winScroll=document.body.scrollTop||document.documentElement.scrollTop;var height=content.scrollHeight;var scrolled=(winScroll/height)*100;if(scrolled<=100){document.getElementById("indicator").style.width=scrolled+"%";}else{document.getElementById("indicator").style.width="100%";}}});(function(menuConfig){var defaultConfig={mobileMenuMode:'overlay',animationSpeed:300,submenuWidth:300,doubleClickTime:500,mobileMenuExpandableSubmenus:false,wrapperSelector:'.navbar',buttonSelector:'.navbar__toggle',menuSelector:'.navbar__menu',submenuSelector:'.navbar__submenu',mobileMenuSidebarLogoSelector:null,relatedContainerForOverlayMenuSelector:null,separatorItemClass:'is-separator',parentItemClass:'has-submenu',submenuLeftPositionClass:'is-left-submenu',submenuRightPositionClass:'is-right-submenu',mobileMenuOverlayClass:'navbar_mobile_overlay',mobileMenuSubmenuWrapperClass:'navbar__submenu_wrapper',mobileMenuSidebarClass:'navbar_mobile_sidebar',mobileMenuSidebarOverlayClass:'navbar_mobile_sidebar__overlay',hiddenElementClass:'is-hidden',openedMenuClass:'is-active',noScrollClass:'no-scroll',relatedContainerForOverlayMenuClass:'is-visible'};var config={};Object.keys(defaultConfig).forEach(function(key){config[key]=defaultConfig[key];});if(typeof menuConfig==='object'){Object.keys(menuConfig).forEach(function(key){config[key]=menuConfig[key];});}
...
init();})(window.themeMenuConfig);function enableStickyToc(){}
